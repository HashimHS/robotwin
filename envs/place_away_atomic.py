...
class place_away_atomic(Base_Task):
    ...
    def play_once(self):
        ...
        self.move(self.move_by_displacement(arm_tag=arm_tag, z=0.13, move_axis="arm"))
    ...
    def check_success(self):
        ...
        edge_x = 0.23
        return (np.all(abs(object_pose[0]) > abs(edge_x)) and self.robot.is_left_gripper_open()
