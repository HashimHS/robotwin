...
class stack_blocks_three_r(Base_Task):
    ...
    def load_actors(self):
        ...
        # `np.random` is seeded with the episode seed (`random` is not), so that an
        # episode is reproducible from its seed and the collection phase replays
        # exactly what the seed phase planned.
